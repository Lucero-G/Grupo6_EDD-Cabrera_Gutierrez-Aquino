...
public class DemoArreglosUNI01 {
    ...
    public static void main(String[] args) {
        ...
        ArregloUnidimensional arr2 = new ArregloUnidimensional();
        
        //Llenamos arreglo
        arr2.insertar(0, "Zafiro");
        arr2.insertar(1, "Aime");
        arr2.insertar(2, "Luis");
        arr2.insertar(3, "Bertin");
        arr2.insertar(4, "Coco");

        System.out.print("Original: ");
        arr2.imprimir();

        // 1. Búsqueda por valor
        int pos = arr2.buscar("Luis")+1;
        System.out.println("Busqueda lineal 'Luis': posicion " + pos);
        ...
        // 3. Búsqueda Binaria (funciona porque ya ordenamos)
        pos = arr2.busquedaBinaria("Bertin")+1;
        System.out.println("Busqueda binaria 'Bertin': posicion " + pos);

        // 4. Inserción Ordenada
        // "Daniel" debería quedar entre Coco y Luis
        arr2.insertarOrdenado("Daniel"); 
        System.out.print("Inserción ordenada 'Daniel': ");
        arr2.imprimir();
